...
module.exports = ({ dbHelpers, loggers }) => {
  ...
  async function embellishFixture(fixture, options = {}, categoryCompositions) {
    ...
    if (embellishedFixtureCache.has(cacheKey)) {
      ...
      DD(`No cache hit for key [${cacheKey}]. Calculating embellished fixture.`);
      ...
      await infringementManager.processTeamInfringements(baseEmbellished, baseEmbellished.team1, baseEmbellished.infringements.team1, currentLane);
      await infringementManager.processTeamInfringements(baseEmbellished, baseEmbellished.team2, baseEmbellished.infringements.team2, currentLane);
