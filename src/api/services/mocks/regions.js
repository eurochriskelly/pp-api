...
module.exports = () => {
  ...
  const mockRegionInfoData = {
    ...
    benelux: {
      ...
      data: [
        ...
        // Club 3 (Luxembourg) - 5 teams
        {
          ...
          city: 'Luxembourg',
          clubId: 303,
          clubName: 'Luxembourg Irish Club',
          clubStatus: 'A',
          country: 'LU',
          domain: null,
          post_code: null,
    ...
    northwest: {
      header: {
        ...
        region: 'northwest',
        subregion: null,
      }, // activeTeamsCount is 2 because one team is inactive
      data: [
        {
          category: 'gaa',
          city: 'Brest',
  ...
  return {
    ...
    listRegionInfo: async (regionString, { sex, sport, level }) => {
      II(
        `Mock: listRegionInfo called for region [${regionString}] with filters:`,
        { sex, sport, level }
      );
